  ...
  return (
    <div ref={themeChangerToYellow} className='h-full pb-10 overflow-hidden'>
        <div className='px-10 MB:px-5 microMB:px-4 flex justify-between items-start min-h-screen h-full flex-col relative'>
            ...
            <div className='sm:h-full tablet:h-full sm:pr-10 pr-2 md:pt-0 sm:pt-20 tablet:pt-20 pt-5 sm:w-screen tablet:w-screen w-max flex justify-end items-center sm:absolute tablet:absolute sm:top-0 tablet:top-0 sm:left-0 tablet:left-0'>
                <video src="/videos/symbol_3@lg.webm" loop autoPlay muted loading="lazy" className='sm:w-[400px] w-[330px] MB:w-[290px] microMB:w-[80vw] max-w-[280px]'></video>
            </div>
