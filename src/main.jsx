...
const BackgroundVideoEffect = () => {
    ...
    return (<>
        <div className="w-screen h-screen absolute top-0 left-0 overflow-hidden z-[1]">
            <div ref={videoCon1} className='absolute top-1/2 left-1/2 w-full h-full -translate-x-1/2 -translate-y-1/2 duration-1000 ease-out' onClick={() => {
                nextvideo();
                ...
                <Tilt ref={videoTiltCon1} tiltEnable={bgVideoStates.tiltVideo1} className='w-full h-full duration-1000 ease-out'>
            ...
            <div ref={videoCon2} className='absolute top-1/2 left-1/2 w-60 h-60 -translate-x-1/2 -translate-y-1/2 duration-1000 ease-out' onClick={() => {
                nextvideo();
                updateState(prev => ({...prev, tiltVideo2: false, tiltVideo3: true}));
                ...
                <Tilt ref={videoTiltCon2} tiltEnable={bgVideoStates.tiltVideo2} className='w-full h-full duration-1000 ease-out'>
                    <video ref={video2} src={`/videos/hero-2.mp4`} muted loop className='w-full h-full object-cover rounded-xl'></video>
                </Tilt>
            </div>
            <div ref={videoCon3} className='absolute top-1/2 left-1/2 w-0 h-0 -translate-x-1/2 -translate-y-1/2 duration-1000 ease-out' onClick={() => {
                ...
                <Tilt ref={videoTiltCon3} tiltEnable={bgVideoStates.tiltVideo3} className='w-full h-full duration-1000 ease-out'>
                    <video ref={video3} src={`/videos/hero-3.mp4`} muted loop className='w-full h-full object-cover rounded-xl'></video>
                </Tilt>
            </div>
            <div ref={videoCon4} className='absolute top-1/2 left-1/2 w-0 h-0 -translate-x-1/2 -translate-y-1/2 duration-1000 ease-out' onClick={() => {
                ...
                <Tilt ref={videoTiltCon4} tiltEnable={bgVideoStates.tiltVideo4} className='w-full h-full duration-1000 ease-out'>
                    <video ref={video4} src={`/videos/hero-4.mp4`} muted loop className='w-full h-full object-cover rounded-xl'></video>
                </Tilt>
            </div>
        </div>
</>)}